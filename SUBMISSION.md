...
**Business Model + Global Readiness (20%).** Screening, triage and the referral PDF are free forever; the only paid step is the optional teleconsult booking. Three sustainability streams: (1) **Teleconsult service fee** — a small platform fee is added on top of the doctor's fixed consultation fee at booking (e.g., doctor charges ৳600, patient pays ৳700 as a single transparent price); the doctor keeps 100% of their fee, the platform retains the ৳100 service fee. (2) **NRB Sponsor-a-District** — diaspora pledges fund free screenings in named districts (working demo widget in-app; ~1.7M Bangladeshis abroad send >$20B/yr in remittances with no health-impact channel today). (3) **Anonymised epidemiology** shared with MoHFW / DGHS / icddr,b under non-commercial licence, funded by Gates / USAID / WHO SEARO grants. Unit economics: $0.0003 / inference, $40 / month hosting at 10k MAU, break-even ~45 bookings / month. Phase 3 expands to Hindi and Urdu RAG corpora — South Asia ready.
